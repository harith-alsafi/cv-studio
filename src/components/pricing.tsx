...
export default function Pricing({ onClose }: PricingProps) {
  return (
    <div className="bg-background text-foreground p-6 rounded-lg max-w-4xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="border-2 relative" style={{ borderColor: "hsl(var(--cv-accent))" }}>
          ...
          <CardHeader>
            ...
            <CardDescription>Unlock unlimited CV creation with premium features</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
