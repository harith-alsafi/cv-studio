                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative">
                        <Button
                            variant="outline"
                            size="icon"
                            className="h-10 w-10 rounded-full ml-2 border-border bg-background hover:bg-accent hover:text-accent-foreground dark:bg-[#1a1f2e] dark:border-[#2a3042] dark:hover:bg-[#2a3042]"
                            ...
                            <div className="absolute right-0 mt-2 w-56 rounded-md shadow-lg bg-card border border-border dark:bg-[#1a1f2e] dark:border-[#2a3042] z-50 animate-in slide-in-from-top-5 duration-300">
                                <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                    ...
                                    >
                                        ...
                                        <span>Credits: </span>
                                        <span className="ml-1 font-medium text-[hsl(var(--cv-accent))]">100</span>
                                    </button>
                                </div>
                            </div>
                        )}
